...
namespace CodeFirstMigrations.Migrations
{
    ...
    [Migration("20241128070934_Adding-Participator-Individual-Coporate-Custom-Configurations")]
    partial class AddingParticipatorIndividualCoporateCustomConfigurations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CodeFirstMigrations.Entities.Participator", b =>
                {
                    ...
                    b.Property<string>("ParticipatorType")
                        .IsRequired()
                        .HasMaxLength(4)
                        .HasColumnType("VARCHAR");
                    ...
                    b.HasDiscriminator<string>("ParticipatorType").HasValue("Participator");
            ...
            modelBuilder.Entity("CodeFirstMigrations.Entities.Coporate", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("COPT");
                });
